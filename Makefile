...
test-basic-http-client-contract:
	$(CXX) $(CXXFLAGS) \
		core/http/src/BasicHttpClient.cpp \
		core/http/tests/test_basic_http_client_contract.cpp \
		-o /tmp/test_basic_http_client_contract
	/tmp/test_basic_http_client_contract
