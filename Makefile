...
test-epgsearch-native-fuzzy-capability-detector:
	$(CXX) $(CXXFLAGS) -Icore/vdr/include \
		...
		-o /tmp/test_epgsearch_native_fuzzy_capability_detector
	/tmp/test_epgsearch_native_fuzzy_capability_detector
...
test-search-timer-workflow-delete-absence-verification-service:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_search_timer_workflow_delete_absence_verification_service
	/tmp/test_search_timer_workflow_delete_absence_verification_service
...
test-search-timer-workflow-create-readback-verification-service:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_search_timer_workflow_create_readback_verification_service
	/tmp/test_search_timer_workflow_create_readback_verification_service
...
test-search-timer-workflow-backend-readback-verification-result:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_search_timer_workflow_backend_readback_verification_result
	/tmp/test_search_timer_workflow_backend_readback_verification_result
...
test-search-timer-workflow-backend-write-allowlist:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_search_timer_workflow_backend_write_allowlist
	/tmp/test_search_timer_workflow_backend_write_allowlist
...
test-search-timer-workflow-guarded-executor-invocation:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_search_timer_workflow_guarded_executor_invocation
	/tmp/test_search_timer_workflow_guarded_executor_invocation
...
test-search-timer-workflow-command-request-mapper:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_search_timer_workflow_command_request_mapper
	/tmp/test_search_timer_workflow_command_request_mapper
...
test-search-timer-workflow-execution-service:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_search_timer_workflow_execution_service
	/tmp/test_search_timer_workflow_execution_service
...
test-search-timer-workflow-planning-service:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_search_timer_workflow_planning_service
	/tmp/test_search_timer_workflow_planning_service
...
test-search-timer-workflow-validation-result-json-serializer:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_search_timer_workflow_validation_result_json_serializer
	/tmp/test_search_timer_workflow_validation_result_json_serializer

test-search-timer-workflow-validation-service:
	$(CXX) $(CXXFLAGS) \
		core/vdr/src/SearchTimerWorkflowValidationService.cpp \
		core/vdr/tests/test_search_timer_workflow_validation_service.cpp \
		-o /tmp/test_search_timer_workflow_validation_service
	/tmp/test_search_timer_workflow_validation_service
...
test-search-timer-automation-read-only-service:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_search_timer_automation_read_only_service
	/tmp/test_search_timer_automation_read_only_service
...
clean:
	...
	rm -f /tmp/test_search_timer_create_request_parser
	...
	rm -f /tmp/test_epgsearch_native_fuzzy_capability_restore_service
	rm -f /tmp/test_epgsearch_native_fuzzy_startup_restore_service
	rm -f /tmp/test_epgsearch_native_fuzzy_startup_restore_diagnostics
