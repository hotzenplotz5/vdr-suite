...
test-http-listener-image-head-of-line:
	$(BUILD_CXX) $(CXXFLAGS) -pthread \
		core/http/src/SimpleHttpListener.cpp \
		core/http/tests/test_simple_http_listener_image_head_of_line.cpp \
		-o $(BUILD_DIR)/test_simple_http_listener_image_head_of_line
