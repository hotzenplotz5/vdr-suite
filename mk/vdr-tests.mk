...
test-epgsearch-native-fuzzy-capability-repository:
	$(CXX) $(CXXFLAGS) \
		...
		$(LDFLAGS) \
		-o /tmp/test_epgsearch_native_fuzzy_capability_repository
	/tmp/test_epgsearch_native_fuzzy_capability_repository
...
test-epgsearch-native-fuzzy-capability-restore-service:
	$(CXX) $(CXXFLAGS) \
		...
		$(LDFLAGS) \
		-o /tmp/test_epgsearch_native_fuzzy_capability_restore_service
	/tmp/test_epgsearch_native_fuzzy_capability_restore_service
...
test-epgsearch-native-fuzzy-operator-refresh-controller:
	$(CXX) $(CXXFLAGS) \
		...
		$(LDFLAGS) \
		-o /tmp/test_epgsearch_native_fuzzy_operator_refresh_controller
	/tmp/test_epgsearch_native_fuzzy_operator_refresh_controller
...
test-search-timer-create-result-json-serializer:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_search_timer_create_result_json_serializer
	/tmp/test_search_timer_create_result_json_serializer
...
test-mock-vdr-timer-action-executor:
	$(CXX) $(CXXFLAGS) \
		...
		-o /tmp/test_mock_vdr_timer_action_executor
	/tmp/test_mock_vdr_timer_action_executor
