...
test-suite-bridge-svdrp-artwork-transport: check-suite-bridge-epg-metadata-contract
	$(BUILD_CXX) $(CXXFLAGS) -pthread -Icore/agent/include -Icore/vdr/include \
		$(AGENT_SVDRP_TRANSPORT_SRC) \
...
check-suite-bridge-epg-metadata-contract:
