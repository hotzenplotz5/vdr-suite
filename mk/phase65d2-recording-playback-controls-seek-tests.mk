...
test-phase65d2-hls-resume-profile:
	...
	$(BUILD_DIR)/test_phase65d2_hls_resume_profile
...
test-fast: test-phase65d2-recording-media-session-seek test-phase65d2-recording-media-session-seek-activation test-phase65d2-vdr-recording-index-updater test-phase65d2-recording-index-marker-fingerprint test-phase65d2-recording-playback-status-request-parser test-phase65d2-recording-start-position-parser test-phase65d2-hls-resume-profile test-phase65d2-hls-resume-command test-vdr-recording-query-service test-vdr-recording-cache-repository
