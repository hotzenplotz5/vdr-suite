.PHONY: test-phase64-native-timer-create-outcome-completion-architecture test-phase64-native-timer-create-outcome-completion

test-phase64-native-timer-create-outcome-completion-architecture:
	python3 tools/check_phase64_native_timer_create_outcome_completion.py

test-phase64-native-timer-create-outcome-completion: test-phase64-native-timer-create-outcome-completion-architecture
	$(BUILD_CXX) $(CXXFLAGS) -Icore/sqlite/include -Icore/operations/include -Icore/timers/include \
		...
		core/timers/tests/test_native_timer_create_outcome_completion.cpp \
		$(LDFLAGS) \
		-o $(BUILD_DIR)/test_native_timer_create_outcome_completion
	$(BUILD_DIR)/test_native_timer_create_outcome_completion
