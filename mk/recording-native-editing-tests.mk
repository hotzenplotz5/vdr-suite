...
test-recording-marks-api-verified-replay:
	$(BUILD_CXX) $(CXXFLAGS) \
		...
		core/vdr/src/VdrRecordingNativeIdentity.cpp \
		$(RECORDING_NATIVE_EDITING_REST_SRC) \
		api/rest/tests/test_recording_marks_api_verified_replay.cpp \
		-o $(BUILD_DIR)/test_recording_marks_api_verified_replay
	$(BUILD_DIR)/test_recording_marks_api_verified_replay
