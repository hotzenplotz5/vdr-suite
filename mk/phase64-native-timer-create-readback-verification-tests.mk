.PHONY: test-phase64-native-timer-create-readback-verification-architecture test-phase64-native-timer-create-readback-verification

test-phase64-native-timer-create-readback-verification-architecture:
	python3 tools/check_phase64_native_timer_create_readback_verification.py

test-phase64-native-timer-create-readback-verification: test-phase64-native-timer-create-readback-verification-architecture
	$(BUILD_CXX) $(CXXFLAGS) -Icore/sqlite/include -Icore/timers/include \
		...
		core/timers/tests/test_native_timer_create_readback_verification_service.cpp \
		$(LDFLAGS) \
		-o $(BUILD_DIR)/test_native_timer_create_readback_verification_service
	$(BUILD_DIR)/test_native_timer_create_readback_verification_service
