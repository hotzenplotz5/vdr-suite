.PHONY: test-phase64-native-timer-absence-readback-expectation-architecture test-phase64-native-timer-absence-readback-expectation

test-phase64-native-timer-absence-readback-expectation-architecture:
	python3 tools/check_phase64_native_timer_absence_readback_expectation.py

test-phase64-native-timer-absence-readback-expectation: test-phase64-native-timer-absence-readback-expectation-architecture
	$(BUILD_CXX) $(CXXFLAGS) -Icore/timers/include \
		...
		$(LDFLAGS) \
		-o $(BUILD_DIR)/test_native_timer_absence_readback_expectation
	$(BUILD_DIR)/test_native_timer_absence_readback_expectation
