...
test-phase69-native-timer-create-productive-runtime: test-phase69-native-timer-create-readback-reconciliation
	$(BUILD_CXX) $(CXXFLAGS) -Icore/sqlite/include -Icore/operations/include -Icore/timers/include -Icore/agent/include -Icore/security/include -Icore/vdr/include 		$(SQLITE_SRC) 		core/security/src/AccountabilityEventRepository.cpp 		core/security/src/CredentialVerifierRepository.cpp 		core/security/src/SecurityIdentityRepository.cpp 		core/security/src/SecurityIdentityProvisioningRepository.cpp 		core/vdr/src/VdrConfig.cpp 		core/vdr/src/BackendRegistry.cpp 		core/vdr/src/BackendRegistryService.cpp 		$(AGENT_CONTROL_PLANE_DOMAIN_SRC) 		core/agent/src/BackendAgentNativeTimerDelete.cpp 		core/agent/src/BackendAgentNativeTimerDeleteAssignment.cpp 		core/agent/src/BackendAgentCommandReservation.cpp 		core/agent/src/BackendAgentNativeTimerCreateReservation.cpp 		core/agent/src/BackendAgentNativeTimerCreateActivation.cpp 		core/operations/src/MutationOperation.cpp 		core/operations/src/MutationOperationRepository.cpp 		core/timers/src/TimerAssignment.cpp 		core/timers/src/TimerAssignmentRepository.cpp 		core/timers/src/TimerAssignmentDesiredNativeTimerSpecification.cpp 		core/timers/src/NativeTimerBinding.cpp 		core/timers/src/NativeTimerBindingRepository.cpp 		core/timers/src/NativeTimerBindingReadRepository.cpp 		core/timers/src/NativeTimerBindingWriteRepository.cpp 		core/timers/src/NativeTimerSpecification.cpp 		core/timers/src/NativeTimerObservation.cpp 		core/timers/src/NativeTimerCreateOperationPayload.cpp 		core/timers/src/NativeTimerCreateReadbackExpectation.cpp 		core/timers/src/NativeTimerCreateReadbackEvidence.cpp 		core/timers/src/NativeTimerCreateReadbackVerificationService.cpp 		core/timers/src/NativeTimerCreateDispatchService.cpp 		core/timers/src/TimerAssignmentFulfillmentService.cpp 		core/timers/src/NativeTimerCreateOperationCompletionService.cpp 		core/daemon/src/NativeTimerCreateResultOutcomeApplication.cpp 		core/daemon/src/NativeTimerCreateReadbackReconciliation.cpp 		core/daemon/src/NativeTimerCreateProductiveRuntime.cpp 		core/daemon/tests/test_native_timer_create_productive_runtime.cpp 		$(LDFLAGS) 		-o $(BUILD_DIR)/test_native_timer_create_productive_runtime
