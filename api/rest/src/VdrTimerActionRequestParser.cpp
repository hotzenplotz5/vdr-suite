...
VdrTimerOperationRequest VdrTimerActionRequestParser::parse(
    const std::string& body) const
{
    ...
    request.stop =
        parseInt(values, "stop", 0);

    request.priority =
        parseInt(values, "priority", 50);

    request.lifetime =
        parseInt(values, "lifetime", 99);
