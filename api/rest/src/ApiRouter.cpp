    ...
    const std::string& body)
{
        ...
        path == "/api/vdr/searchtimers/real-test")
    {
        ...
        return searchTimerController_->realTestSearchTimerWorkflow(body);
    }

    if (path == "/api/searchtimers/execute" ||
        path == "/api/vdr/searchtimers/execute")
    {
        ...
        return searchTimerController_->executeSearchTimerWorkflow(body);
    }

    if (path == "/api/searchtimers/plan" ||
        path == "/api/vdr/searchtimers/plan")
    {
        ...
        return searchTimerController_->planSearchTimerWorkflow(body);
    }
        ...
        path == "/api/vdr/searchtimers/update")
    {
        ...
        return searchTimerController_->updateSearchTimer(
            body,
