...
VDR-Suite is a VDR-centered, domain-first and multi-backend platform.

Current accepted architecture additions:
...
See [Current State](docs/CURRENT.md) and the [ADR Index](docs/adr/index.md) before planning new implementation work.
