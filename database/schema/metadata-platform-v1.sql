-- VDR-Suite Suite Metadata Platform Schema
-- Phase 61.2: canonical schema contract version 1
--
-- This schema intentionally coexists with the legacy Phase-1 tables named
-- metadata and artwork. Those legacy tables are not renamed or reinterpreted.
-- Runtime migration and repository integration are Phase 61.3 work.
...
CREATE TABLE IF NOT EXISTS suite_metadata_targets (
    ...
    CHECK (
        target_type IN ('recording', 'program-event', 'timer-intent')
    ),
