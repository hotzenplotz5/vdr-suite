...
ACTIVE_END = "---"
EXPECTED_LATEST = "ADR-0049"
EXPECTED_NEXT = "ADR-0050"
...
def main():
    ...
    if "0050" in active_numbers:
        errors.append("ADR-0050 is listed active although it is the next available number")
