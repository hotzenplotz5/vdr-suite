...
ACTIVE_END = "---"
EXPECTED_LATEST = "ADR-0053"
EXPECTED_NEXT = "ADR-0054"
...
def main():
    ...
    if "0054" in active_numbers:
        errors.append("ADR-0054 is listed active although it is the next available number")
