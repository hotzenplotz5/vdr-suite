...
ACTIVE_END = "---"
EXPECTED_LATEST = "ADR-0045"
EXPECTED_NEXT = "ADR-0046"
...
def main():
    ...
    if "0046" in active_numbers:
        errors.append("ADR-0046 is listed active although it is the next available number")
