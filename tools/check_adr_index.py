...
ACTIVE_END = "---"
EXPECTED_LATEST = "ADR-0044"
EXPECTED_NEXT = "ADR-0045"
...
def main():
    ...
    if "0045" in active_numbers:
        errors.append("ADR-0045 is listed active although it is the next available number")
