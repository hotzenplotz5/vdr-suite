...
ACTIVE_END = "---"
EXPECTED_LATEST = "ADR-0054"
EXPECTED_NEXT = "ADR-0055"
...
def main():
    ...
    if "0055" in active_numbers:
        errors.append("ADR-0055 is listed active although it is the next available number")
