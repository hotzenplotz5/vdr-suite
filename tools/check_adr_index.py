...
ACTIVE_END = "---"
EXPECTED_LATEST = "ADR-0046"
EXPECTED_NEXT = "ADR-0047"
...
def main():
    ...
    if "0047" in active_numbers:
        errors.append("ADR-0047 is listed active although it is the next available number")
