...
for marker in ("SuiteBridgePrioritizedArtworkTransport","SuiteBridgePrioritizedMetadataTransport","SuiteBridgePrioritizedRecordingMetadataTransport","SuiteBridgeReadTransportStatus::Unavailable"):
