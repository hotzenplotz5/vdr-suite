...
for marker in ("ProtocolMajor=1","MaximumRequestPayloadBytes","MaximumResponsePayloadBytes","LiveCapability=1","LiveOpen=2","LiveStatus=3","LiveClose=4","NativeProbeCapability=5","NativeProbeExecute=6","NativeProbeReadback=7","CriticalControl=1","DeadlineExpired","Overloaded"):
