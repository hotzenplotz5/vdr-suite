...
def check_prepared_searchtimer_module_source_contract() -> None:
    ...
    required_tokens = [
        ...
        "blacklist_mode",
        "use_vps",
        "Weitere Live-Paritätsfelder",
        "Abbrechen",
        "Speichern",
        "Vorschau",
        "data-searchtimer-action",
        "name = 'search'",
        "Neuer SearchTimer",
        "data-searchtimer-editor-form",
        "data-searchtimer-editor",
        ...
        "searchtimer-preview-match-heading",
        "searchtimer-preview-badges",
        "searchtimer-preview-badge",
        "searchtimer-preview-description",
        ...
        "searchtimer-preview-summary",
        "searchtimer-preview-warnings",
        "searchtimer-preview-matches",
        "Technische JSON-Details",
        ...
        "data-searchtimer-preview-result",
        "Wiederholungen, Serien und Blacklist",
        "Kanal-, Zeit- und Dauerfilter",
        "Aufnahmeoptionen",
...
def check_app_searchtimer_module_bridge_contract(app_js: str) -> None:
    required_tokens = [
        ...
        "clientApi: frontendPlatformClientApi()",
...
def check_style_contract(style_css: str, app_js: str) -> None:
    ...
    searchtimer_editor_required_tokens = [
        ...
        ".searchtimer-editor-preview-json",
        ".searchtimer-preview-summary",
        ".searchtimer-preview-metric",
        ".searchtimer-preview-section",
        ".searchtimer-preview-match",
        ".searchtimer-preview-match-heading",
        ".searchtimer-preview-badges",
        ".searchtimer-preview-badge",
        ".searchtimer-preview-description",
        ".searchtimer-preview-technical",
