...
void printUsage()
{
    std::cout
        << "Usage:\n"
        << "  restfulapi_recording_action_real_delete_smoke "
        << "--host 127.0.0.1 --port 8002 "
        << "--source '<vdr-recording-source>' [--execute]\n\n"
...
RestfulApiRecordingActionBackendConfig makeConfig(const Options& options)
{
...
RecordingActionRequest makeRequest(const Options& options)
{
...
RecordingActionJobPayload makePayload(const Options& options)
{
