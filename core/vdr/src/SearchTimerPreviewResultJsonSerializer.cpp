...
void SearchTimerPreviewResultJsonSerializer::appendQuoted(
    std::ostringstream& json,
...
void SearchTimerPreviewResultJsonSerializer::appendStringArray(
    std::ostringstream& json,
...
const char* SearchTimerPreviewResultJsonSerializer::stateToJson(
