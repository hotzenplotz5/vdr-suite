...
int main()
{
...

    {
        ...
        VdrRecordingNativeMetadata negative; negative.availability = VdrRecordingNativeMetadataAvailability::NotFound; negative.schema = 1;
        negative.found = false; negative.reason = "provider-no-match"; negative.provider = "none"; negative.recordingIdentitySchema = 1;
        negative.recordingKey = key; negative.mediaType = "none"; negative.preferredArtwork.provider = "none";
        assert(repository.storeResolution("default", nativeId, negative, 2200, 0, 3000));
