...
private:
        ...
        std::size_t& position)
    {
        ...
        const std::size_t colon = body.find(':', field + marker.size());
        ...
        long long& value)
    {
        ...
        const bool quoted = body[position] == '"';
        ...
        const std::size_t digitStart = position;
        ...
        const std::string number = body.substr(start, position - start);
