...
| Live Plugin Parity | Source audit, gap matrix, read-only discovery domain foundation, JSON contract and REST controller contract are documented and implemented; service contract is planned next. |
