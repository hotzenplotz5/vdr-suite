...
| Live Plugin Parity | Source audit, gap matrix, read-only discovery domain foundation and JSON contract are documented and implemented; REST controller contract is planned next. |
