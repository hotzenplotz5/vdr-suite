...
| Teletext / HbbTV | Next numbered domain, not started | Phase 67 / ADR-0054. |
...
- Phase-67 Teletext/HbbTV acceptance remains future work and requires real broadcast/yaVDR evidence.
