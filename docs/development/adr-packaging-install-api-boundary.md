# ADR - Packaging, Install Layout and API Boundary
...
Phase 56 is preparing VDR Suite for a future packageable layout without introducing real Debian packaging yet.
