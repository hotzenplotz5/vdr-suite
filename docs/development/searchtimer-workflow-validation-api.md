...
Phase 50.49 adds a dedicated test for the full SearchTimer verified execution path.
...
The planned verifier must prove that the deleted backend-native id is absent after a successful delete result.
