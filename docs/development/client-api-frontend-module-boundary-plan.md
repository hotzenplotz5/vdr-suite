...
- `web/frontend/modules/searchtimers.js` is prepared and registered through the platform; SearchTimer remains visible in the module navigation and defines Live-parity slots for VPS, blacklist, filters, preview and write actions.
