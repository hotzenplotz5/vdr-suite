...
- The physical script now lives at `web/frontend/modules/channels.js`.
- `index.html`, `mk/install.mk`, and the daemon frontend whitelist now serve `/frontend/modules/channels.js`.
