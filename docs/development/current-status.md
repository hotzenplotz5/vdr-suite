...
The next implementation phase should introduce an explicit executor opt-in boundary so real backend mutation cannot happen unless both the execution mode and service wiring deliberately enable it.
