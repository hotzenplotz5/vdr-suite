...
| G-25 | Stable public API version/error/compatibility contract | Active — Phase 69.A inventory | Internal Suite client contracts exist; Phase 69 has started by inventorying/classifying pre-v1 routes before declaring stable `/api/v1` resources. | ADR-0048 / Phase 69 kickoff |
