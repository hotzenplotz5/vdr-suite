...
| ---: | --- | --- | --- | --- |
| 1 | Architecture package ADR-0042-ADR-0049 | In progress; ADR-0042 through ADR-0045 accepted | Core contracts | Complete the remaining streaming, OSD, API and audit decisions plus diagrams and dependency map. |
