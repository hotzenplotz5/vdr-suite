...
| ---: | --- | --- | --- | --- |
| 1 | Architecture package ADR-0042-ADR-0049 | In progress; ADR-0042 accepted | Core contracts | Complete the remaining job, timer, EPG, streaming, OSD, API and audit decisions plus diagrams and dependency map. |
