...
| ---: | --- | --- | --- | --- |
| 1 | Architecture package ADR-0042-ADR-0049 | Planned next work | Core contracts | Complete mutation, job, timer, EPG, streaming, OSD, API and audit decisions plus diagrams and dependency map. |
