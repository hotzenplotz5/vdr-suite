...
| ---: | --- | --- | --- | --- |
| 1 | Architecture package ADR-0042-ADR-0049 | In progress; ADR-0042 through ADR-0048 accepted | Core contracts | Complete the remaining audit decision plus diagrams and dependency map. |
