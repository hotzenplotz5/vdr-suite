...
| ---: | --- | --- | --- | --- |
| 1 | Architecture package ADR-0042-ADR-0049 | In progress; ADR-0042 through ADR-0047 accepted | Core contracts | Complete the remaining API and audit decisions plus diagrams and dependency map. |
