(function (global) {
  ...
  function installStyles() {
    ...
    style.textContent =
      ...
      '.media-home-discovery-card{scroll-snap-align:start;min-width:0;border:1px solid rgba(226,232,240,.15);border-radius:.95rem;background:linear-gradient(155deg,rgba(15,23,42,.58),rgba(2,6,23,.72));box-shadow:inset 0 1px 0 rgba(255,255,255,.04),0 .8rem 2rem rgba(2,6,23,.18);color:#e2e8f0;text-align:left;overflow:hidden;padding:0;cursor:pointer;transition:border-color .16s ease,box-shadow .16s ease,transform .16s ease}' +
      '.media-home-discovery-card:hover{border-color:rgba(125,211,252,.52);box-shadow:inset 0 1px 0 rgba(255,255,255,.05),0 .95rem 2.2rem rgba(2,6,23,.24),0 0 1.2rem rgba(251,191,36,.04);transform:translateY(-1px)}' +
      ...
      '.media-home-discovery-card.genre,.media-home-discovery-card.folder,.media-home-discovery-card.folder-root{min-height:7rem;padding:.35rem;background:linear-gradient(145deg,rgba(30,41,59,.68),rgba(2,6,23,.80));box-shadow:inset 0 1px 0 rgba(255,255,255,.04),0 .7rem 1.8rem rgba(2,6,23,.16)}' +
      '.media-home-discovery-state{margin:0 1rem 1rem;padding:1rem;border:1px solid rgba(226,232,240,.13);border-radius:.9rem;color:#94a3b8;background:linear-gradient(145deg,rgba(15,23,42,.46),rgba(2,6,23,.62));box-shadow:inset 0 1px 0 rgba(255,255,255,.03)}' +
      ...
      '@media(prefers-reduced-motion:reduce){.media-home-discovery-card{transition:none}.media-home-discovery-card:hover{transform:none}}';
    doc.head.appendChild(style);
  }
