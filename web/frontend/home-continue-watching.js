(function (global) {
  ...
  function useFallback(artwork, fallback) {
  ...
  function render(items) {
    ...
    if (!section) {
      ...
      section.setAttribute('aria-labelledby', 'media-home-continue-title');
    ...
    valid.forEach(function (item) {
      ...
      resume.setAttribute('aria-label', item.title + ' fortsetzen');
      ...
      restart.setAttribute('aria-label', item.title + ' von vorn abspielen');
  ...
  function installStyles() {
    ...
    style.textContent = '#detail:has(.module-tab.active[data-module="overview"]){display:flex;flex-direction:column}#detail:has(.module-tab.active[data-module="overview"]) [data-home-zone="additional-sections"]{order:40}#detail:has(.module-tab.active[data-module="overview"]) [data-home-zone="primary-rail"]{order:50}#detail:has(.module-tab.active[data-module="overview"]) #detail-data{order:60}.media-home-continue-watching{min-width:0}.media-home-continue-rail{display:grid;grid-auto-flow:column;grid-auto-columns:minmax(17rem,24rem);gap:.85rem;overflow-x:auto;padding:0 .25rem 1rem;scroll-snap-type:x proximity}.media-home-continue-card{scroll-snap-align:start;display:grid;grid-template-columns:6rem 1fr;gap:.8rem;padding:.8rem;border:1px solid rgba(226,232,240,.15);border-radius:1rem;background:linear-gradient(155deg,rgba(15,23,42,.58),rgba(2,6,23,.72));box-shadow:inset 0 1px 0 rgba(255,255,255,.04),0 .8rem 2rem rgba(2,6,23,.18);transition:border-color .16s ease,box-shadow .16s ease,transform .16s ease}.media-home-continue-artwork{display:grid;place-items:center;align-self:start;width:100%;aspect-ratio:2/3;overflow:hidden;border-radius:.75rem;background:linear-gradient(145deg,#1e293b,#334155);font-size:2rem;font-weight:800}.media-home-continue-artwork.is-fallback{position:relative;background:radial-gradient(circle at 70% 22%,rgba(56,189,248,.2),transparent 32%),linear-gradient(145deg,#172033,#26364d);color:#dbeafe;text-shadow:0 .12rem .5rem rgba(2,6,23,.75)}.media-home-continue-artwork.is-fallback::after{content:"";position:absolute;inset:.45rem;border:1px solid rgba(148,163,184,.18);border-radius:.55rem;pointer-events:none}.media-home-continue-artwork img{display:block;width:100%;height:100%;object-fit:cover}.media-home-continue-copy{min-width:0}.media-home-continue-copy h4,.media-home-continue-copy p{margin:.1rem 0 .45rem}.media-home-continue-copy progress{width:100%;accent-color:#38bdf8}.media-home-continue-card:hover{border-color:rgba(125,211,252,.52);box-shadow:inset 0 1px 0 rgba(255,255,255,.05),0 .95rem 2.2rem rgba(2,6,23,.24),0 0 1.2rem rgba(251,191,36,.04);transform:translateY(-1px)}.media-home-continue-actions{display:flex;flex-wrap:wrap;gap:.45rem;margin-top:.65rem}.media-home-continue-actions button{min-width:2.75rem;min-height:2.75rem;padding:.55rem .75rem;border-radius:.65rem;transition:transform .14s ease,border-color .14s ease}.media-home-continue-actions button:hover{transform:translateY(-1px)}.media-home-continue-actions button:focus-visible{outline:3px solid rgba(125,211,252,.96);outline-offset:2px}@media(min-width:120rem){.media-home-continue-rail{grid-auto-columns:minmax(22rem,29rem);gap:1.15rem}.media-home-continue-card{grid-template-columns:7.5rem 1fr;padding:1rem}}@media(min-width:46.01rem){.media-home-continue-rail{grid-auto-columns:minmax(11rem,15rem);gap:.8rem;padding:0 1rem 1.1rem}.media-home-continue-card{grid-template-columns:1fr;gap:0;padding:0;overflow:hidden}.media-home-continue-artwork{border-radius:0}.media-home-continue-copy{display:grid;gap:.25rem;padding:.7rem}.media-home-continue-actions{display:grid;grid-template-columns:1fr;gap:.45rem}.media-home-continue-actions button{width:100%}}@media(max-width:46rem){.media-home-continue-rail{grid-auto-columns:minmax(80vw,20rem)}.media-home-continue-card{grid-template-columns:5rem 1fr}}@media(prefers-reduced-motion:reduce){.media-home-continue-card,.media-home-continue-actions button{transition:none}.media-home-continue-card:hover,.media-home-continue-actions button:hover{transform:none}.media-home-continue-rail{scroll-behavior:auto}}';
