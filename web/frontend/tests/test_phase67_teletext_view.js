...
assert(teletext.includes("body.vdr-suite-teletext-open::after"));
assert(teletext.includes("pointer-events:auto"));
assert(teletext.includes("body.vdr-suite-teletext-open .vdr-suite-live-tv-grid{pointer-events:none!important}"));
assert(teletext.includes("body.vdr-suite-teletext-open .vdr-suite-live-tv-channel{pointer-events:none!important}"));
assert(teletext.includes("pointer-events:auto!important"));
assert(teletext.includes("linear-gradient(180deg,#020617 0%,#07111f 100%)"));
assert(teletext.includes("padding:0!important;border:0!important"));
