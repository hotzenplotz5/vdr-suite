...
int main()
{
  static_assert(SuiteBridgeLocalContractPayload::SchemaVersion() == 4);
  ...
  const char *expectedActive =
      "{\"contract_schema\":4,\"capability_schema\":1,\"snapshot_schema\":4,\"active\":true,\"total\":32,\"channel_switch\":12,\"recording\":2,\"recording_list\":6,\"replaying\":3,\"timer_change\":4,\"marks_modified\":5,\"counter_epoch\":\"0123456789abcdef0123456789abcdef\",\"counter_overflow\":false}";
  ...
  const char *expectedInactive =
      "{\"contract_schema\":4,\"capability_schema\":7,\"snapshot_schema\":4,\"active\":false,\"total\":0,\"channel_switch\":0,\"recording\":0,\"recording_list\":0,\"replaying\":0,\"timer_change\":0,\"marks_modified\":0,\"counter_epoch\":\"fedcba9876543210fedcba9876543210\",\"counter_overflow\":true}";
