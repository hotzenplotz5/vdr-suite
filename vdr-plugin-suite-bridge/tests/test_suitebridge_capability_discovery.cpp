...
int main()
{
  ...
  const char *expected =
      "{\"discovery_schema\":1,\"plugin_name\":\"suitebridge\",\"plugin_version\":\"0.13.0\",\"capability_schema\":1,\"snapshot_schema\":4,\"local_contract_schema\":4,\"capabilities\":[{\"id\":\"lifecycle\",\"state\":\"available\"},{\"id\":\"status-events\",\"state\":\"available\"},{\"id\":\"snapshots\",\"state\":\"available\"},{\"id\":\"local-contract\",\"state\":\"available\"},{\"id\":\"recording-metadata\",\"state\":\"available\"},{\"id\":\"recording-marks\",\"state\":\"available\"},{\"id\":\"recording-cut-state\",\"state\":\"available\"},{\"id\":\"epg-type-snapshot\",\"state\":\"available\"},{\"id\":\"vdr.live.stream\",\"state\":\"available\"},{\"id\":\"osd.view\",\"state\":\"available\"},{\"id\":\"osd.control\",\"state\":\"available\"},{\"id\":\"mutations\",\"state\":\"disabled\"}]}";
