#ifndef VDR_SUITE_BRIDGE_RECORDING_CUT_H
#define VDR_SUITE_BRIDGE_RECORDING_CUT_H
...
struct SuiteBridgeRecordingCutRequest final {
...
enum class SuiteBridgeRecordingCutDisposition {
  AcceptedUnverified,
  RejectedWithoutEffect,
  OutcomeUnknown,
};

struct SuiteBridgeRecordingCutMutationResult final {
...
class ISuiteBridgeRecordingCutMutationCallback {
public:
  virtual ~ISuiteBridgeRecordingCutMutationCallback() = default;
  virtual SuiteBridgeRecordingCutMutationResult StartCut(
      const SuiteBridgeRecordingCutRequest &request) = 0;
};

class SuiteBridgeRecordingCutService final {
public:
  explicit SuiteBridgeRecordingCutService(
      std::string pluginInstanceEpoch,
      ISuiteBridgeRecordingCutMutationCallback *mutationCallback = nullptr,
...
private:
  ...
  SuiteBridgeRecordingCutMutationResult executeReserved(
  ...
  ISuiteBridgeRecordingCutMutationCallback *mutationCallback_ = nullptr;
