...
std::size_t SuiteBridgeControlPlane::operationIndex(Operation o){auto v=static_cast<std::uint16_t>(o);return v>=1&&v<=7?static_cast<std::size_t>(v-1):0;}
